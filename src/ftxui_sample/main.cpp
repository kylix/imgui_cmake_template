...
// configuration step. It creates a namespace called `imgui_cmake_template`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", imgui_cmake_template::cmake::project_name, imgui_cmake_template::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", imgui_cmake_template::cmake::project_version);
      return EXIT_SUCCESS;
    }
